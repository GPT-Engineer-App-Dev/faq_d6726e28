    ...
    <Box maxWidth="800px" mx="auto" py={8} px={4}>
      ...
      <Accordion allowMultiple>
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>We accept returns within 30 days of delivery. Items must be in new and unused condition with all original packaging. Some exclusions apply. Please see our full Return Policy for details.</AccordionPanel>
        </AccordionItem>
      </Accordion>
    </Box>
  );
